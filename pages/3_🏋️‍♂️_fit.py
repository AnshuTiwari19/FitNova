...
# Create database engine and fetch exercise names
...
# Populate exercise keywords for dropdown
exercise_keywords = ['']
...
if exercise_keyword != '':
    with engine.connect() as conn:
        exercise_result = conn.execute(
            text("SELECT * FROM Exercise WHERE Name = :name"),
    ...
    # Layout for video, overview, and instructions
